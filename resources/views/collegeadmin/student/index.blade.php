...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="{{route('collegeadmin.dashbord')}}"><i class="fa fa-dashboard"></i>Collega admin </a></li>
...
<section class="content-header">
	<div class="conrainer-fluid">
		...
		<div class="col-md-4" style="float: right;">
			<form action="{{ route('collegeadmin.student.index') }}" method="get" >
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped">
			...
			<tr>
				...
				<td>{{ $s->stu_sem }}</td>
				{{-- <td>
					<a href="{{route('collegeadmin.student.edit',$s->id) }}" class="btn btn-info"> <i class="glyphicon glyphicon-edit"></i></a>
					
					<a href="javascript:void(0)" onclick="$(this).parent().find('form').submit()" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
					<form action="{{ route('collegeadmin.student.destroy',$s->id) }}" method="post">
						@method('DELETE')
