...
<div class="conrainer-fluid">
        ...
        <div class="col-md-4" style="float: right;">
	    	<form action="{{ route('collegeadmin.eventcodinator.display') }}" method="get" >
		...
		<table class="table table-bordered table-striped">
			...
			@foreach($students as $s)
				<tr>
					...
					<td>{{ $s->stu_sem }}</td>
					<td>
						<a href="{{route('collegeadmin.eventcodinator.show',$s->id) }}" class="btn btn-info">Add As Event Codinator</a>
					</td>
				</tr>
			@endforeach
			@else
