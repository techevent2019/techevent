...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('collegeadmin.eventcodinator.index')}}"> Event Codinator </a></li>
        <li><a href="{{route('collegeadmin.eventcodinator.display')}}">Add Event Codinator</a></li>
...
@if(\Session::has('danger'))
    ...
    <div class="row">
        ...
        <form action="{{ route('collegeadmin.eventcodinator.store',$id) }}" method="POST">
                ...
                {{-- <div class="form-group">
                    ...
                    <select name="event_id" class="form-control">
                        <option value="">Choose Event Id</option>
                            @foreach($events as $e)
