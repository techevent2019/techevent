...
<div class="page-header">
	...
	<div class="col-md-4" style="float: right;">
		<form action="{{ route('collegeadmin.event.display') }}" method="get" >
...
<table class="table table-bordered table-striped">
	...
	<tr>
		...
		{{-- <td>{{ $e->e_c_id }}</td> --}}
		<td>
			<a href="{{route('collegeadmin.event.edit',$e->id) }}" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i></a>
		</td>
		<td>
			<form action="{{ route('collegeadmin.event.destroy',$e->id) }}" method="POST">
				{{ csrf_field() }}
		...
		{{-- <td>
			<a href="{{route('collegeadmin.event.publish',$e->id) }}" class="btn btn-success"><i class="fa fa-paragraph"></i></a>
		</td> --}}
	</tr>
	@endforeach
	@else
