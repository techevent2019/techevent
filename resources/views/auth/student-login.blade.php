...
<div class="text-center" style="padding:50px 0">
    <div class="logo">login As Student</div>
    <!-- Main Form -->
    ...
    <div class="login-form-1">
        <form id="login-form" class="text-left" method="POST" action="{{ route('student.login.submit') }}">
        @csrf
            ...
            <div class="etc-login-form">
                <p>forgot your password? <a href="{{ route('student.password.request') }}">click here</a></p>
            </div>
            @endif
            <div class="etc-login-form">
                <p>for new registration? <a href="{{ route('student.register') }}">click here</a></p>
            </div>
