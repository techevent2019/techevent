...
<div class="text-center" style="padding:50px 0">
    <div class="logo">login As College Admin</div>
    <!-- Main Form -->
    <div class="login-form-1">
        <form id="login-form" class="text-left" method="POST" action="{{ route('collegeadmin.login.submit') }}">
        @csrf
            ...
            <div class="etc-login-form">
                <p>forgot your password? <a href="{{ route('collegeadmin.password.request') }}">click here</a></p>
            </div>
            @endif
