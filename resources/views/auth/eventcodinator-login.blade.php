...
<div class="text-center" style="padding:50px 0">
    <div class="logo">login As Event Codinator</div>
    <!-- Main Form -->
    <div class="login-form-1">
        <form id="login-form" class="text-left" method="POST" action="{{ route('eventcodinator.login.submit') }}">
        @csrf
            ...
            <div class="etc-login-form">
                <p>forgot your password? <a href="{{ route('eventcodinator.password.request') }}">click here</a></p>
            </div>
            @endif
