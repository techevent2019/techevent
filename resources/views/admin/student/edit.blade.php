...
<section class="content-header">
	<div class="conrainer-fluid">
		<form method="post" action="{{ route('admin.student.update',$students->id) }}">
			@method('PUT')
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-6"><input type="text" name="stu_enrollment_no" class="form-control {{ $errors->has('stu_enrollment_no') ? ' is-invalid' : '' }}" value="{{ $students->stu_enrollment_no}}">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-6"><input type="text" name="stu_col_code" class="form-control {{ $errors->has('stu_col_code') ? ' is-invalid' : '' }}" value="{{ $students->stu_col_code}}">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-6"><input type="text" name="stu_col_name" class="form-control {{ $errors->has('stu_col_name') ? ' is-invalid' : '' }}" value="{{ $students->stu_col_name}}">
