...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.event.display') }}">Display Events </a></li>
    <li class="active">Edit Events</li>
  </ol>
</section>
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <form action="{{ route('admin.event.update1',$id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="number" name="col_cod" class="form-control {{ $errors->has('col_cod') ? ' is-invalid' : '' }}" value="{{ $events->col_cod }}" required autofocus placeholder="Enter College Code"/>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="college_name" class="form-control {{ $errors->has('college_name') ? ' is-invalid' : '' }}" value="{{ $events->college_name  }}" required autofocus placeholder="Enter College Name"/>
          ...
          <div class="form-group">
            ...
            <input type="text" name="college_address" class="form-control {{ $errors->has('college_address') ? ' is-invalid' : '' }}" value="{{ $events->college_address  }}" required autofocus placeholder="Enter College Address"/>
          ...
          <div class="form-group">
            ...
            <input type="text" name="city" class="form-control {{ $errors->has('city') ? ' is-invalid' : '' }}" value="{{ $events->city  }}" required autofocus placeholder="Enter City"/>
            @if ($errors->has('city'))
            <span class="invalid-feedback" role="alert">
          ...
          <div class="form-group">
            ...
            <div class="row">
              <h4 class="col-md-10">Min: <input type="number" name="min_member" value="{{ $events->min_member }}" />
              
              Max: <input type="number" name="max_member" value="{{ $events->max_member }}" />
              </h4>
            </div>
